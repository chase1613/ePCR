...
const POSITIONS = ['ACCOUNTANT III','ADMINISTRATIVE AIDE III','ADMINISTRATIVE AIDE IV','ADMINISTRATIVE AIDE V','ADMINISTRATIVE AIDE VI','ADMINISTRATIVE ASSISTANT II','ADMINISTRATIVE ASSISTANT III','ADMINISTRATIVE OFFICER II','ADMINISTRATIVE OFFICER IV','ADMINISTRATIVE OFFICER V','ATTORNEY III','ATTORNEY IV','ATTORNEY V','ATTORNEY VI','CHIEF HUMAN RESOURCE SPECIALIST','DIRECTOR II','DIRECTOR III','DIRECTOR IV','HUMAN RESOURCE SPECIALIST I','HUMAN RESOURCE SPECIALIST II','OIC - CHIEF HUMAN RESOURCE SPECIALIST','SENIOR HUMAN RESOURCE SPECIALIST','SPECIAL INVESTIGATOR II','SPECIAL INVESTIGATOR III','SUPERVISING HUMAN RESOURCE SPECIALIST']

const DIVISIONS = ['ANTI-RED TAPE UNIT','EXAMINATION RESOURCE DIVISION','HUMAN RESOURCE DIVISION','LEGAL SERVICES DIVISION','MANAGEMENT SERVICES DIVISION','OFFICE OF THE REGIONAL DIVISION','PUBLIC ASSISTANCE AND LIASON DIVISION','POLICIES AND SYSTEMS EVALUATION DIVISION','CSC FIELD OFFICE OF AKLAN','CSC FIELD OFFICE OF ANTIQUE','CSC FIELD OFFICE OF CAPIZ','CSC FIELD OFFICE OF GUIMARAS','CSC FIELD OFFICE OF ILOILO','CSC FIELD OFFICE OF NEGROS ISLAND REGION']

const NAMES = ['AARON, CRISNELL P.','AGENGA, LEO M., JR.','AGUIRRE, MARIA THERESA J.','AMOLAR, ALMA KRISTINA A.','ARENDAIN, APRIL MAE D.','BRAZA, ROCELYN G.','CANG, CHRISTOPHER Z.','CAPADOSA, PHILIP BERNARD H.','CARDONA, DONATO A.','CENTINA, NELLE JUNE C.','DE LA TORRE, DONNA MARIE B.','DELGADO-JIMENO, MARYDEL MAY B.','ELIZAN, ERNA T.','ESCANER, MARILYN L.','FLORES, FLORINDA G.','GAITANO, VIZUR-TY C.','GELLANGARIN, KATE LUV D.','GENER, MARY GRACE L.','GENITO, JESS RENEN M.','HALLARA, RENATO J.','IGNACIO, BENJIE Z.','JARDENIL, JUNE MARK J.','JAVELLANA, AYANAH E.','LADIGOHON, ANDRE L.','LEGASTE, ESPER HERMINIO G.','LONGNO, LEO T.','MACOGUE, FERDINAND R.','MALLORCA, JOSE ROGER S.','MAMON, JECELYN M.','MENGUILLO, TERESITA V.','NARTEA, MICHELLE JOY O.','OBLIGACION, AILEEN S.','PALOMO, MA. ROSCELIN H.','PIANSAY, MARUEL JOY L.','PILLA, KENT C.','PILLADO, MA. ANNA C.','REFUGIO, RAMON P., JR.','RUBIAS, MARIA CARLA M.','SABLA-ON, KRISTINE E.','SALAZAR, MA. GILDA E.','SEGURA, ELAINE L.','SERRA, AURELIO S., JR.','SOLIDIO, MITZI LOUISE B.','SORIANO, MARK ALFRED N.','SORTIGOSA, DONNALYN P.','TAN, JAMES BYRON M.','TEMBREVILLA, MEGEL G.','TINGSON, MARY MONICA JEAN B.','TIQUISON, EMMY LOU G.','TORALBALLA, JOELYN MARIE L.','VIDAL, EDWARD S.','VILLANUEVA, SHEILA MAE L.','VILLANUEVA, CHAD GIAN G.','YBIERNAS, GLYZELLE DIANE D.']
